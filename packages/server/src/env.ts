...
export const chaincode = process.env.CHAINCODE || 'convector-example-people-attributes';
...
export const couchDBView = process.env.COUCHDBVIEW || 'ch1_convector-example-people-attributes';
